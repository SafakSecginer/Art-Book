package com.kafasrengices.artbookjava;
...
import com.kafasrengices.artbookjava.databinding.ActivityArtBinding;
...
public class ArtActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (info.equals("new")) {
            ...
            binding.imageView.setImageResource(R.drawable.ic_add_foreground);
